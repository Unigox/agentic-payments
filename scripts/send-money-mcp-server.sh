...
if missing_dependency "@modelcontextprotocol/sdk" || missing_dependency "zod" || missing_dependency "@ton/crypto" || missing_dependency "@ton/ton" || missing_dependency "ethers" || missing_dependency "tweetnacl"; then
